<!-- AUTO-GENERATED by ~/.claude/bin/sync-agents-md.sh. Do not edit by hand. -->
<!-- Sources: CLAUDE.md + .claude/CLAUDE.md + .claude/rules/*.md -->
<!-- Regenerate: ~/.claude/bin/sync-agents-md.sh /home/user/Desktop/Projects/harness_helper -->

# Project Instructions (mirrored for Codex CLI)
